...
class WeatherViewModel {
    ...
    func dailyConfigureCell (cell: testDailyCollectionViewCell, indexPath: IndexPath) -> testDailyCollectionViewCell {
       ...
       // print( dateFormater(date: (weather.dailyWeather!.daily[indexPath.row].dt), dateFormat: "E d MMM") )
        return cell
    }
